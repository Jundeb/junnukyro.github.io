...
const AboutMe = () => {
    return (
        <div id='about' className='about'>
            ...
            Before I got selected for Degree Programme in Information Technology, I had zero experience in programming, but now I feel that the days are too short for feeding my raging passion towards it.<br /><br />
