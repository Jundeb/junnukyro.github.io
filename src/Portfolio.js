                ...
                <div className='portfolio-cards'>
                    <div className='portfolio-card'>
                        ...
                        <div className='card-text'>
                            ...
                            <p>Projects idea was to create a web bank in which users can browse their accounts balances, transactions and transfer money to other accounts. Also users can update their personal information, change passord and create a credit account. <br /><br /> Use this account for direct access to webbank:<br /> Username: Jannu<br /> Password: Jannu1!</p>
                        </div>
